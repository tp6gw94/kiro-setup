---
name: simplify
description: Use a reviewer -> worker -> reviewer pipeline to simplify recent changes without changing behavior. Load when the user requests simplification, lower complexity, removal of unnecessary abstractions, or cleanup of a recent diff.
---
...
Use the user-supplied scope. If none is supplied, use recent changes.
