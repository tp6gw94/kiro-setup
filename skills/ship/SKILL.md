---
name: ship
description: Use parallel specialist reviewers to produce a launch GO/NO-GO decision and rollback plan. Load for pre-launch review, release readiness, ship decisions, or production launch checks.
---
...
Use the user-supplied diff, commit, or release scope. If none is supplied, use the current staged and unstaged diff; if empty, use recent commits.

This skill is a read-only pre-launch gate. It must not deploy, push, merge, release, or modify project files without separate explicit user authorization.
