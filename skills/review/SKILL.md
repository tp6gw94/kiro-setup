---
name: review
description: Run parallel fresh-context reviewers across correctness, tests, architecture, simplicity, security, and performance. Load when the user asks to review a diff, commit, branch, pull request, or current changes.
---
...
Use the user-supplied diff, commit, or scope. If none is supplied, use the current staged and unstaged diff; if empty, use recent commits.
