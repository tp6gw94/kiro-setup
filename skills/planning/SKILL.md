---
name: planning
description: Use a planner subagent to turn a specification into ordered, verifiable tasks. Load when the user requests an implementation plan, task breakdown, planning from a SPEC, or a structured todo list.
---
