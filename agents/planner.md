...
## Core Responsibility
Read all provided inputs, then write `.plan/<task-name>/task.md` containing a complete execution plan the Supervisor can follow to dispatch worker agents.
